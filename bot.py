...
# Load groups and chats allowed
allowed_chats = os.getenv("ALLOWED_CHATS").split(",")
ALLOWED_CHAT_IDS = [int(chat_id) for chat_id in allowed_chats]
...
async def not_allowed_reply(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("No sé quién chuchas eres, si tienes algún problema contacta con el equipo de IT de eurielec.")
