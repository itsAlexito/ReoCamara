...
async def send_video(chat_id, output_file, context: ContextTypes.DEFAULT_TYPE, MESSAGE_LIFETIME):
...
async def send_image(chat_id, image_file, context: ContextTypes.DEFAULT_TYPE, MESSAGE_LIFETIME):
